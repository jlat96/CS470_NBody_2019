This is the serial version of the FMM code. We were able to improve it's performance by removing some extraneous calculation during each frame. It can be tested using the test.sh file.
